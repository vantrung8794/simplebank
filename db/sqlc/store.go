...
// TranferTx ferforms a money transfer from one acccoun to the other.
// It creates a transfer record, add account entries, update accout's balance within single DB transaction.
